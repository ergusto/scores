        ...
        <div className="grid gap-6">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="px-2 bg-white text-slate-600">Already have an account? <Link href="/auth/sign-in" className='underline decoration-black underline-offset-2 text-slate-600'>Sign In</Link></span>
            </div>
          </div>
        </div>
      </div>
